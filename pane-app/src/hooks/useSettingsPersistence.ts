...
export function useSettingsPersistence() {
  ...
  useEffect(() => {
    const save = () => {
      ...
      const { controlPanelVisible, controlPanelWidth, fontSize, panelFontSize, theme } = useWorkspaceStore.getState();
    ...
    // Save when project state changes (file opened, dir expanded)
    // This ensures state survives Vite HMR reloads
