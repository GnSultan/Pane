...
const API_KEY_PROVIDERS: ApiKeyProvider[] = [
  ...
  { key: "elevenlabs", label: "ElevenLabs (Voice)", placeholder: "sk_...", docsUrl: "https://elevenlabs.io/app/settings/api-keys" },
  { key: "openai", label: "OpenAI (Voice fallback)", placeholder: "sk-...", docsUrl: "https://platform.openai.com/api-keys" },
